...
LDFLAGS =-O3 -fopenmp -std=gnu++11 -lmgl -lgsl -lgslcblas -lnlopt -lglut -lGLU -lGL -march=native

CXXDEBUGFLAGS =-g -O0  -march=native 
LDDEBUGFLAGS =-g -O0 -lmgl -lgsl -lgslcblas -lnlopt -lglut -lGLU -lGL -march=native
