...
const DimensionType MaxDimension=5;
...
// in the debug mode, this class also records the dimension of the GeometryVector
class GeometryVector
{
  public:
    ...
    double x[ ::MaxDimension];  // what is x? what is the meaning of this definition
    GeometryVector(){
#ifdef GEOMETRYVECTOR_RECORDDIMENSION
      this->Dimension=0;
#endif
    ...
    // otherwise GeometryVector(2) would be ambiguous.
