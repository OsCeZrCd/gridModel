...
// const double d2minDecay = 0.612;//no data, copied from T=0.025, needs updating
// const int nGridPerSide = 100;
//T=0.070
const double meanSoftness = 13.42;
const double stdSoftness = 3.92;
const double d2minDecay = 0.579;
const int nGridPerSide = 100;
//T=0.085
// const double meanSoftness = 13.01;
// const double stdSoftness = 4.00;
// const double d2minDecay = 0.536;
// const int nGridPerSide = 100;
//T=0.1
